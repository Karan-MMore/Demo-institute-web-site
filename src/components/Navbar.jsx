        ...
        <div className="relative mx-auto max-w-full px-6 lg:max-w-5xl xl:max-w-7xl 2xl:max-w-[96rem]">
          ...
          >
            ...
            >
             ...
             <span className=" text-3xl Roboto text-orange-500">Arrow</span><span className=" text-3xl Roboto text-gray-600">Technology</span>
            </a>
            {/*      <!-- Mobile trigger --> */}
            <button
            ...
            >
              ...
              <li role="none" className="flex items-stretch">
                <span className="flex items-center gap-2 py-4 transition-colors duration-300 hover:text-emerald-600 focus:bg-emerald-50 focus:outline-none focus-visible:outline-none lg:px-8">
                    <Dropdown/>
                </span>
              </li>
              <li role="none" className="flex items-stretch">
